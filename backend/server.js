...
app.listen(PORT, async () => { 
    ...
    try {
        ...
        const message = error.message.split('\n').find(line => line.includes('Authentication failed')) || error.message;

        console.error('Error Details:', message.substring(0, 150) + '...');
        console.error('Please check your DATABASE_URL in the .env file and ensure the database container is running.');
    }
});